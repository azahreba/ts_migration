...
if (QUnit) {
    ...
    QUnit.test("Can create CoinCounter View Model and defaults are as expected", function (assert) {
        var ccvm = new CoinCounterViewModel(), hsl = ccvm.highScoreList();
    ...
    QUnit.test("Can add and remove a coin to DOM", function (assert) {
        var ccvm = new CoinCounterViewModel(), coin = coins[0], tempContainer = document.getElementById("tempContainer");
